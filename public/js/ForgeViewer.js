...
function launchViewer(urn, viewableId) {
  ...
  Autodesk.Viewing.Initializer(options, () => {
    const config = {
      extensions: ['Autodesk.VisualClusters', 'Autodesk.DocumentBrowser', 'MyAwesomeExtension', 'ModelSummaryExtension', 'ObjectCodeExtension']
    };
  ...
  function onDocumentLoadSuccess(doc) {
    ...
    //viewer.loadExtension('ObjectCodeExtension', { objectCodeProperty: 'BiolerDATA - ObjectCode' });
    });
  }
